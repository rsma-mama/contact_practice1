  ...
  <main>
    ...
    <div class="form__group">
      ...
      <div class="form__group-content form__group-content--tel">
        ...
        <div class="form__input--text">
          <input type="tel" name="tel2" maxlength="4" placeholder="1234" value="{{ $contact['name'] }}" readonly/>
        </div>
        <span class="form__hyphen">-</span>
        <div class="form__input--text">
          <input type="tel" name="tel3" maxlength="4" placeholder="5678" value="{{ $contact['name'] }}" readonly/>
        </div>
        <div class="form__error">
          <!--バリデーション機能を実装したら記述します。-->
        </div>
